            ...
            for idx, row in games_df.iterrows():
                ...
                for team_side in ('home', 'away'):
                    ...
                    for player in players:
                        if stats_dict["teams"][team_side]["players"][f"{player}"]["stats"].get("skaterStats") is not None:
                            skater_stats = stats_dict["teams"][team_side]["players"][f"{player}"]["stats"]["skaterStats"]
